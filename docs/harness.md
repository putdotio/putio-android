...
through `connectedAndroidTest` on the booted emulator. Opt-in feature suites and
the separately scheduled OAuth regression are not part of this launch proof.
